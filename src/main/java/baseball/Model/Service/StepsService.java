...
public class StepsService {
    public static void updateResult (StepsResult result, int[] arr1, int[] arr2) {
    ...
    private static void compareValue (StepsResult result, int i1, int value1, int i2, int value2) {
    ...
    public static String getResult(StepsResult result) {
